...
/**
 * Enforces business hours on existing future slots (fonte: clinica_business_hours).
 */
 ...
 * Fonte da verdade: clinica_business_hours (sem linha para o DOW = horário liberado).
 */
export async function generateSlotsForCompany(
  ...
  for (const company of companies) {
    const [bhRows, specialties] = await Promise.all([
      ...
      prisma.clinicaSpecialty.findMany({
