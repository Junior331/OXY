...
def build_router_prompt(context: dict) -> str:
    ...
    if lodging_config.get("hotel_enabled"):
        svc_names.append("Hotel para pacientes")
...
• Terceiro oferecendo parceria, venda, marketing, serviços **para** o clinica (B2B)
...
onboarding_agent → primeira mensagem, saudação, cadastro de paciente
  Gatilhos: "oi", "olá", "bom dia", querer cadastrar paciente, cliente novo
...
Se o histórico mostrar que a assistente JÁ concluiu com sucesso um cadastro de paciente ou um agendamento, e a mensagem atual for só agradecimento/encerramento
