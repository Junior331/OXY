...
def build_lodging_agent(context: dict, router_ctx: dict) -> Agent:
    ...
    company_name = context.get("company_name") or "o clinica"
...
Sua responsabilidade: gerenciar hospedagens (hotel e creche para pacientes).
{type_ctx}{date_ctx}
...
- NUNCA peça o valor da diária ao cliente — ele vem da configuração do clinica via get_kennel_availability
